...
export default function Home() {
    return (
        ...
        <div className="relative overflow-hidden min-h-screen bg-brand-dark flex flex-col min-[800px]:grid min-[800px]:grid-cols-[1fr_minmax(0,calc(800px+20px))_1fr]">
            ...
            <main className="w-full flex justify-center bg-transparent">
                <div
                    className="w-full max-w-[800px] mx-[10px] flex flex-col items-center justify-start relative z-10 bg-white/5 dark:bg-white/5 backdrop-blur-sm"
                    style={{
